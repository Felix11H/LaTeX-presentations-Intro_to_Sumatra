...
\newminted[mlineshell]{bash}{fontsize=\small, linenos,
               		numbersep=11pt,
               		gobble=4,
               		frame=lines,
                        bgcolor=bg,
...
\input{frames/git_primer.tex}

\input{frames/smt_setup.tex}

\input{frames/first_project.tex}

\input{frames/beyond.tex}
